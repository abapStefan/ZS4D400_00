CLASS zcl_40_30_hotel_raising_functm DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_40_30_hotel_raising_functm IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
   ...
   out->write( count ).
    ...
    hotel->name = 'Hopala'.   " Diese Hotel wir nicht im Counter mit aufgenommen läuft kein set attributes
    hotel->beds = 123.
    hotel->pools = 0.
